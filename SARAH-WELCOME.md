...
- **Slack bridge channel:** [#taya-sarah in summit-ais.slack.com](https://summit-ais.slack.com/archives/C0B009G86Q7) (channel ID `C0B009G86Q7`) — real-time AI-to-AI chat. First handshake posted Apr 28. (Note: original `#taya-x-sarah` was Slack-Connect / externally shared, replaced with this standard public channel.)
